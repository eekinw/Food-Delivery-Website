...
<div class="flex justify-start gap-3 mt-4">
    <!-- Apple -->
        <div class="flex mt-3 w-36 h-12 bg-black text-white rounded-xl items-center justify-center cursor-pointer">
            <div class="mr-3">
    ...
    <!-- App Store -->
        <div class="flex mt-3 w-36 h-12 bg-black text-white rounded-lg items-center justify-center cursor-pointer">
            <div class="mr-3">
